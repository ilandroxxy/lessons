...
# https://education.yandex.ru/ege/inf/task/1e0cb6b4-4bc0-4443-bd23-71dbb3d80d36
# У исполнителя есть три команды, которые обозначены латинскими буквами:
# A. Прибавить 1.
# B. Умножить на 2.
# C. Умножить на 3.
# Сколько существует программ, для которых при исходном
# числе 1 результатом является число 25, при этом траектория
# вычислений содержит число 11 и не содержит 15?
'''
def F(a, b):
    if a > b or a == 15:
        return 0
...
# 1 куча: -3, -7, /3 до меньшего | s <= 11 | s > 11

'''
n = 1: Первый шаг - Петя первый ход 
n = 2: Второй шаг - Ваня первый ход
n = 3: Третий шаг - Петя второй ход
n = 4: Четвертый шаг - Ваня второй ход
'''
