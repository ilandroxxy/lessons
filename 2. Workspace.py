...
# При регистрации в компьютерной системе каждому объекту присваивается идентификатор,
# состоящий из 317 символов и содержащий только десятичные цифры и символы из 4090-символьного
...
alp = 10 + 4090  # alp = 2 ** i
# print(2 ** 13, alp)
i = 13  # - это кол-во бит на один символ

bit = sym * i   # - кол-во бит на один пароль
print(bit / 8)  # 515.125 -> 516  # - кол-во байт на пароль
byte = 516
...
M = [x ** 2 for x in range(2, 100) if x % 2 != 0]
