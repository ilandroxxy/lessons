...
#  10. Заменить номер https://stepik.org/lesson/1038667/step/15?unit=1062772 на задачу: 23746 и почистить "форум решений" (просто все удалить)
#  11. Заменить номер https://stepik.org/lesson/1038432/step/8?unit=1060804 на задачу: 23742 и почистить "форум решений" (просто все удалить)
#  12. Полностью убрать все содержимое ДОМАШЕК по 12 номеру и "форум ответов" почистить, затем заменить не задачами с КОМПЕГЭ  https://stepik.org/lesson/1038682/step/1?unit=1062773
#  13. Полностью убрать все содержимое ПРАКТИК по 12 номеру и "форум ответов" почистить, затем заменить не задачами с КОМПЕГЭ  https://stepik.org/lesson/1038682/step/1?unit=1062773
...
# Действия над строкой (конкатенация) - склеивание
'''
r = ''
r += '4'
r += '4'
...
# Пример самого простого калькулятора систем счисления
'''
alp = sorted('0123456789QWERTYUIOPASDFGHJKLZXCVBNM')
...
while True:
    ...
    if case == '1':
        ...
        n = int(r, b)  # встроенная функция перевода
        print(f'Результат перевода числа {r} из {b}-й систему в 10-ю: {n}')
        ...
        n = int(r, b)
        m = convert(n, k)
        print(f'Результат перевода числа {r} из {b}-й систему в {k}-ю: {m}')
        ...
        print('Программа принимает только команды: 0, 1, 2, 3')
'''
...
print(sorted('28HIUgrji099'))
# ['0', '2', '8', '9', '9', 'H', 'I', 'U', 'g', 'i', 'j', 'r']
